...
public class MongoServiceBindingConverter implements ServiceBindingConverter {
    ...
    public Optional<ServiceBindingConfigSource> convert(List<ServiceBinding> serviceBindings) {
        ...
        String user = bindings.get("username");
        String password = bindings.get("password");
        String host = bindings.getOrDefault("host", "localhost");
        String port = bindings.get("port");
        String hostPort;
        if( port == null ) {
            hostPort = host;
        } else {
        ...
        String database = bindings.getOrDefault("database", "");
